...
const MODELS = [
  ...
  { id: 'gpt-5.5-pro', name: 'gpt-5.5-pro (<272K context length)', price: '$30 input / $180 output per 1M tokens' },
  { id: 'gpt-5.4', name: 'gpt-5.4 (<272K context length)', price: '$2.5 input / $15 output per 1M tokens' },
  { id: 'gpt-5.4-mini', name: 'gpt-5.4-mini (Default)', price: '$0.75 input / $4.5 output per 1M tokens' },
  { id: 'gpt-5.4-nano', name: 'gpt-5.4-nano', price: '$0.2 input / $1.25 output per 1M tokens' },
  { id: 'gpt-5.4-pro', name: 'gpt-5.4-pro (<272K context length)', price: '$30 input / $180 output per 1M tokens' },
  { id: 'gpt-5.2', name: 'gpt-5.2', price: '$1.75 input / $14 output per 1M tokens' },
  { id: 'gpt-5.2-pro', name: 'gpt-5.2-pro', price: '$21 input / $168 output per 1M tokens' },
  { id: 'gpt-5.1', name: 'gpt-5.1', price: '$1.25 input / $10 output per 1M tokens' },
  { id: 'gpt-5', name: 'gpt-5', price: '$1.25 input / $10 output per 1M tokens' },
  { id: 'gpt-5-mini', name: 'gpt-5-mini', price: '$0.25 input / $2 output per 1M tokens' },
  { id: 'gpt-5-nano', name: 'gpt-5-nano', price: '$0.05 input / $0.4 output per 1M tokens' },
  { id: 'gpt-5-pro', name: 'gpt-5-pro', price: '$15 input / $120 output per 1M tokens' },
  { id: 'gpt-4.1', name: 'gpt-4.1', price: '$2 input / $8 output per 1M tokens' },
  { id: 'gpt-4.1-mini', name: 'gpt-4.1-mini', price: '$0.4 input / $1.6 output per 1M tokens' },
  { id: 'gpt-4.1-nano', name: 'gpt-4.1-nano', price: '$0.1 input / $0.4 output per 1M tokens' },
  { id: 'gpt-4o', name: 'gpt-4o', price: '$2.5 input / $10 output per 1M tokens' },
  { id: 'gpt-4o-2024-05-13', name: 'gpt-4o-2024-05-13', price: '$5 input / $15 output per 1M tokens' },
  { id: 'gpt-4o-mini', name: 'gpt-4o-mini', price: '$0.15 input / $0.6 output per 1M tokens' },
  { id: 'o1', name: 'o1', price: '$15 input / $60 output per 1M tokens' },
  { id: 'o1-pro', name: 'o1-pro', price: '$150 input / $600 output per 1M tokens' },
  { id: 'o3-pro', name: 'o3-pro', price: '$20 input / $80 output per 1M tokens' },
  { id: 'o3', name: 'o3', price: '$2 input / $8 output per 1M tokens' },
  { id: 'o4-mini', name: 'o4-mini', price: '$1.1 input / $4.4 output per 1M tokens' },
  { id: 'o3-mini', name: 'o3-mini', price: '$1.1 input / $4.4 output per 1M tokens' },
  { id: 'o1-mini', name: 'o1-mini', price: '$1.1 input / $4.4 output per 1M tokens' },
  { id: 'gpt-4-turbo-2024-04-09', name: 'gpt-4-turbo-2024-04-09', price: '$10 input / $30 output per 1M tokens' },
  { id: 'gpt-4-0125-preview', name: 'gpt-4-0125-preview', price: '$10 input / $30 output per 1M tokens' },
  { id: 'gpt-4-1106-preview', name: 'gpt-4-1106-preview', price: '$10 input / $30 output per 1M tokens' },
  { id: 'gpt-4-1106-vision-preview', name: 'gpt-4-1106-vision-preview', price: '$10 input / $30 output per 1M tokens' },
  { id: 'gpt-4-0613', name: 'gpt-4-0613', price: '$30 input / $60 output per 1M tokens' },
  { id: 'gpt-4-0314', name: 'gpt-4-0314', price: '$30 input / $60 output per 1M tokens' },
  { id: 'gpt-4-32k', name: 'gpt-4-32k', price: '$60 input / $120 output per 1M tokens' },
  { id: 'gpt-3.5-turbo', name: 'gpt-3.5-turbo', price: '$0.5 input / $1.5 output per 1M tokens' },
  { id: 'gpt-3.5-turbo-0125', name: 'gpt-3.5-turbo-0125', price: '$0.5 input / $1.5 output per 1M tokens' },
  { id: 'gpt-3.5-turbo-1106', name: 'gpt-3.5-turbo-1106', price: '$1 input / $2 output per 1M tokens' },
  { id: 'gpt-3.5-turbo-0613', name: 'gpt-3.5-turbo-0613', price: '$1.5 input / $2 output per 1M tokens' },
  { id: 'gpt-3.5-0301', name: 'gpt-3.5-0301', price: '$1.5 input / $2 output per 1M tokens' },
  { id: 'gpt-3.5-turbo-instruct', name: 'gpt-3.5-turbo-instruct', price: '$1.5 input / $2 output per 1M tokens' },
  { id: 'gpt-3.5-turbo-16k-0613', name: 'gpt-3.5-turbo-16k-0613', price: '$3 input / $4 output per 1M tokens' },
  { id: 'davinci-002', name: 'davinci-002', price: '$2 input / $2 output per 1M tokens' },
  { id: 'babbage-002', name: 'babbage-002', price: '$0.4 input / $0.4 output per 1M tokens' }
];
